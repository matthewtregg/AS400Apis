...
(function () {
  return new Promise(async (resolve, reject) => {
    console.log('Invoked PgmCode.createDBConnection');
...
getPgmSource(pgmID, DBname) {
  return new Promise ((resolve, reject) => {
    console.log('Invoked PgmCode.getPgmSource');

    connObj.query = `SELECT PGMID, STN, MVAR, MVARDB FROM ${DBname}.PGMCODE WHERE PGMID = '${pgmID}'`;

    resolve(index.executeQuery(connObj));
  })
}
